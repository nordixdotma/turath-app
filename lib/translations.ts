export const translations = {
  en: {
    ...
    // Hero Section
    hero_title: "Preserving the Past, Empowering the Future",
    hero_description:
      "Turâth is a non-profit Moroccan association established in 2021 with the aim of preserving the tangible and intangible heritage of Marrakech and its surrounding region. Embracing a comprehensive vision of heritage, encompassing architecture, landscapes, traditional craftsmanship, and cultural practices, the association unites members who share common values of heritage knowledge, preservation, and promotion.",
    join_us: "Join us",
    discover_more: "Discover More",

    // Add these new translation keys for the typewriter effect
    typewriter_text1: "Preserving Our Heritage",
    typewriter_text2: "Celebrating Traditions",
    typewriter_text3: "Sharing Culture",

    // Historical Places Section
    historical_places_title: "Historical Treasures",
    historical_places_description:
      "Discover the iconic historical sites that make Marrakech a living museum of cultural heritage and architectural splendor.",
    did_you_know: "Did you know?",
    jemaa_el_fnaa_title: "Jemaa el-Fnaa",
    jemaa_el_fnaa_year: "11th century",
    jemaa_el_fnaa_fact:
      "Jemaa el-Fnaa transforms from a marketplace during the day to an entertainment hub at night with storytellers, musicians, and food vendors.",
    koutoubia_mosque_title: "Koutoubia Mosque",
    koutoubia_mosque_year: "12th century",
    koutoubia_mosque_fact:
      "The Koutoubia minaret served as the model for the Giralda of Seville and the Hassan Tower of Rabat.",
    bahia_palace_title: "Bahia Palace",
    bahia_palace_year: "1860s",
    bahia_palace_fact:
      "The name 'Bahia' means 'brilliance' in Arabic, and the palace was built to be the greatest palace of its time.",
    majorelle_garden_title: "Majorelle Garden",
    majorelle_garden_year: "1923",
    majorelle_garden_fact:
      "The distinctive shade of blue used throughout the garden is known as 'Majorelle Blue' and was patented by Jacques Majorelle.",
    el_badi_palace_title: "El Badi Palace",
    el_badi_palace_year: "16th century",
    el_badi_palace_fact:
    ...
    vision_text:
      "We envision a future where every citizen is aware of the richness of their cultural heritage. We aim to create a community deeply engaged in preserving the cultural values of our past and ensuring their continuity into the future.",
    social_icons: "Follow Us",
    useful_links: "Useful Links",
    introduction: "Introduction",
    our_partners: "Our Partners",
    about_us: "About Us",
    our_journeys: "Our Journeys",
    contact_info: "Contact Info",
    address_value: "Musée Mouassine, Derb El Hammam, Mouassine, Marrakech",
    phone_value: "(+212) 662 388 758",
    email_value: "turath.marrakech@gmail.com",
    copyright: "All rights reserved.",
    made_with: "Made with",
    in_morocco: "in Morocco",
    subscribe_title: "Stay Updated",
    subscribe_description: "Subscribe to our newsletter for the latest news and events.",
    ...
    hero_image_alt: "Marrakech heritage showcase",
    background_image_alt: "Background image",
    menu_toggle_alt: "Toggle menu",
    ...
    // About Page
    about_title: "About Turâth",
    about_subtitle: "Preserving the tangible and intangible heritage of Marrakech and its region",
    mission_title: "Our Mission",
    objectives_title: "Objectives of the Association",
    ...
    mission_paragraph_1:
      "Turâth is a Moroccan association established in 2021, non-profit, dedicated to the preservation of the tangible and intangible heritage of the city of Marrakech and its region.",
    mission_paragraph_2:
      "Heritage, in this context, is understood in its broadest sense, encompassing both architectural and landscape elements, as well as the knowledge and cultural practices associated with related professions.",
    mission_paragraph_3:
      "The association brings together members who share common values, such as the understanding of heritage, its preservation, and its valorization, fostering exchange and collaboration across various domains in partnership with private and public institutions.",
    non_profit: "Non-profit",
    non_religious: "Non-religious",
    apolitical: "Apolitical",
    we_are_turath: "We Are Turâth",

    // About Page - Objectives
    objective_1_title: "Awareness / Information",
    ...
    objective_2_title: "Valorization / Restoration",
    ...
    objective_3_title: "Research / Dissemination",
    ...
    objective_4_title: "Heritage Promotion",
    ...
    contact_description: "Have questions about our work or want to get involved? We'd love to hear from you.",
    ...
    message_sent: "Thank you for your message! We'll get back to you soon.",
    ...
    monday_friday: "Monday - Friday: 9:00 AM - 5:00 PM",
    saturday: "Saturday: 10:00 AM - 2:00 PM",
    sunday: "Sunday: Closed",

    // Volunteer Page
    join_team: "Join Our Team",
    volunteer_title: "Volunteer With Turâth",
    volunteer_subtitle: "Be part of our mission to preserve and promote the rich cultural heritage of Marrakech",
    board_subtitle: "Meet the people behind this amazing initiative",
    faq_title: "Frequently Asked Questions",
    faq_subtitle: "Everything you need to know about volunteering with Turâth",
    volunteer_cta_title: "Join Us in Preserving Marrakech's Rich Heritage!",
    ...
    apply_now: "Apply Now",
    faq_question_1: "How to be a volunteer?",
    faq_answer_1:
    ...
    faq_question_2: "What should you know before apply",
    faq_answer_2:
    ...
    faq_question_3: "Information about application process",
    faq_answer_3:
    ...
    faq_question_4: "Volunteer Appreciation Events",
    faq_answer_4:
    ...
    faq_question_5: "Career and Personal Development",
    faq_answer_5:
    ...
    faq_question_6: "Making a Lasting Impact",
    faq_answer_6:
    ...
    faq_question_7: "Spread awareness about volunteering",
    faq_answer_7:
    ...
    faq_question_8: "How you could become an external partner",
    faq_answer_8:
    ...
    faq_question_9: "What Volunteer Benefits Does Turâth Offer?",
    faq_answer_9:
    ...
    faq_question_10: "Volunteer Training and Support",
    faq_answer_10:
    ...
    faq_question_11: "Flexible Volunteering Opportunities",
    faq_answer_11:
    ...
    faq_question_12: "Diverse Volunteer Roles",
    faq_answer_12:
  ...
  fr: {
    ...
    established: "Établie en",

    // Hero Section
    hero_title: "Préserver le Passé, Autonomiser l'Avenir",
    hero_description:
      "Turâth est une association marocaine à but non lucratif créée en 2021 dans le but de préserver le patrimoine matériel et immatériel de Marrakech et de sa région. Embrassant une vision globale du patrimoine, englobant l'architecture, les paysages, l'artisanat traditionnel et les pratiques culturelles, l'association unit des membres qui partagent des valeurs communes de connaissance, de préservation et de promotion du patrimoine.",
    join_us: "Rejoignez-nous",
    discover_more: "En savoir plus",

    // Add these new translation keys for the typewriter effect
    typewriter_text1: "Préserver Notre Patrimoine",
    typewriter_text2: "Célébrer les Traditions",
    typewriter_text3: "Partager la Culture",

    // Historical Places Section
    historical_places_title: "Trésors Historiques",
    historical_places_description:
      "Découvrez les sites historiques emblématiques qui font de Marrakech un musée vivant du patrimoine culturel et de la splendeur architecturale.",
    did_you_know: "Le saviez-vous ?",
    jemaa_el_fnaa_title: "Jemaa el-Fnaa",
    jemaa_el_fnaa_year: "11ème siècle",
    jemaa_el_fnaa_fact:
      "Jemaa el-Fnaa se transforme d'un marché pendant la journée en un centre de divertissement la nuit avec des conteurs, des musiciens et des vendeurs de nourriture.",
    koutoubia_mosque_title: "Mosquée Koutoubia",
    koutoubia_mosque_year: "12ème siècle",
    koutoubia_mosque_fact:
      "Le minaret de la Koutoubia a servi de modèle pour la Giralda de Séville et la Tour Hassan de Rabat.",
    bahia_palace_title: "Palais Bahia",
    bahia_palace_year: "Années 1860",
    bahia_palace_fact:
      "Le nom 'Bahia' signifie 'brillance' en arabe, et le palais a été construit pour être le plus grand palais de son époque.",
    majorelle_garden_title: "Jardin Majorelle",
    majorelle_garden_year: "1923",
    majorelle_garden_fact:
      "La teinte distinctive de bleu utilisée dans tout le jardin est connue sous le nom de 'Bleu Majorelle' et a été brevetée par Jacques Majorelle.",
    el_badi_palace_title: "Palais El Badi",
    el_badi_palace_year: "16ème siècle",
    el_badi_palace_fact:
    ...
    board_description:
      "Nos bénévoles sont le cœur battant de Turâth. Avec passion et dévouement, ils jouent un rôle vital dans la préservation du patrimoine de Marrakech. De la recherche aux événements et aux projets de restauration, leurs contributions ont un impact durable. Rejoignez-nous et faites partie d'une communauté dynamique qui façonne notre héritage culturel.",
    president: "PRÉSIDENTE",
    vice_president: "VICE-PRÉSIDENTE",
    treasurer: "TRÉSORIÈRE",
    deputy_treasurer: "TRÉSORIÈRE ADJOINTE",
    secretary_general: "SECRÉTAIRE GÉNÉRAL",
    president_name: "Soad Belkeziz",
    president_bio:
      "Soad Belkeziz est la présidente fondatrice de Turâth. Avec une passion pour le patrimoine marocain et plus de 15 ans d'expérience dans la préservation culturelle, elle dirige la mission de l'organisation pour sauvegarder le riche héritage culturel de Marrakech.",
    about_president: "À propos de la Présidente",
    meet_full_board: "Rencontrer le conseil complet",
    visit_about_page: "Visitez notre page À propos pour en savoir plus sur chaque membre.",
    ...
    vision_text:
      "Nous envisageons un avenir où chaque citoyen est conscient de la richesse de son patrimoine culturel. Nous visons à créer une communauté profondément engagée dans la préservation des valeurs culturelles de notre passé et à assurer leur continuité dans le futur.",
    social_icons: "Suivez-nous",
    useful_links: "Liens Utiles",
    introduction: "Introduction",
    our_partners: "Nos Partenaires",
    about_us: "À Propos de Nous",
    our_journeys: "Nos Parcours",
    ...
    subscribe_description: "Abonnez-vous à notre newsletter pour les dernières nouvelles et événements.",
    ...
    hero_image_alt: "Vitrine du patrimoine de Marrakech",
    background_image_alt: "Image de fond",
    menu_toggle_alt: "Basculer le menu",
    ...
    // About Page
    about_title: "À propos de Turâth",
    about_subtitle: "Préserver le patrimoine matériel et immatériel de Marrakech et sa région",
    mission_title: "Notre Mission",
    objectives_title: "Objectifs de l'Association",
    objectives_description:
    ...
    // About Page - Mission Section
    mission_paragraph_1:
      "Turâth est une association marocaine créée en 2021, à but non lucratif, dédiée à la préservation du patrimoine matériel et immatériel de la ville de Marrakech et de sa région.",
    mission_paragraph_2:
      "Le patrimoine, dans ce contexte, est compris dans son sens le plus large, englobant à la fois les éléments architecturaux et paysagers, ainsi que les connaissances et pratiques culturelles associées aux métiers connexes.",
    mission_paragraph_3:
      "L'association rassemble des membres qui partagent des valeurs communes, telles que la compréhension du patrimoine, sa préservation et sa valorisation, favorisant l'échange et la collaboration dans divers domaines en partenariat avec des institutions privées et publiques.",
    non_profit: "À but non lucratif",
    non_religious: "Non religieuse",
    apolitical: "Apolitique",
    we_are_turath: "Nous Sommes Turâth",

    // About Page - Objectives
    objective_1_title: "Sensibilisation / Information",
    objective_1_description:
      "Organiser diverses activités (conférences, expositions, visites guidées, relations presse, formations, ateliers de sensibilisation, groupes de réflexion, etc.) dans le but de sensibiliser le grand public (jeunes et moins jeunes) intéressé par le patrimoine et sa préservation.",
    objective_2_title: "Valorisation / Restauration",
    objective_2_description:
    ...
    contact_description:
      "Vous avez des questions sur notre travail ou vous souhaitez vous impliquer ? Nous serions ravis de vous entendre.",
    ...
    message_sent: "Merci pour votre message ! Nous vous répondrons bientôt.",
    ...
    monday_friday: "Lundi - Vendredi: 9h00 - 17h00",
    saturday: "Samedi: 10h00 - 14h00",
    sunday: "Dimanche: Fermé",

    // Volunteer Page
    join_team: "Rejoignez Notre Équipe",
    volunteer_title: "Devenez Bénévole Avec Turâth",
    volunteer_subtitle:
      "Faites partie de notre mission de préservation et de promotion du riche patrimoine culturel de Marrakech",
    board_subtitle: "Rencontrez les personnes derrière cette incroyable initiative",
    faq_title: "Questions Fréquemment Posées",
    faq_subtitle: "Tout ce que vous devez savoir sur le bénévolat avec Turâth",
    volunteer_cta_title: "Rejoignez-nous pour Préserver le Riche Patrimoine de Marrakech !",
    volunteer_cta_description:
      "Faites partie de l'équipe passionnée de Turâth et contribuez à préserver l'héritage culturel de Marrakech. Rejoignez-nous en tant que bénévole et embarquez pour un voyage enrichissant rempli d'apprentissage, de réseautage et d'engagement communautaire.",
    apply_now: "Postulez Maintenant",
    faq_question_1: "Comment devenir bénévole ?",
    faq_answer_1:
      "Pour devenir bénévole chez Turâth, vous pouvez remplir notre formulaire de candidature en ligne, assister à l'une de nos séances d'information ou nous contacter directement. Nous accueillons des personnes de tous horizons qui sont passionnées par la préservation du patrimoine culturel de Marrakech.",

    faq_question_2: "Que devez-vous savoir avant de postuler",
    faq_answer_2:
      "Avant de postuler, il est utile de comprendre notre mission et nos valeurs, l'engagement en temps requis et les types d'opportunités de bénévolat disponibles. Nous vous recommandons de consulter notre site Web et nos réseaux sociaux pour mieux comprendre notre travail et l'impact que nous avons.",

    faq_question_3: "Informations sur le processus de candidature",
    faq_answer_3:
      "Notre processus de candidature comprend le remplissage d'un formulaire, un entretien avec notre coordinateur des bénévoles et une session d'orientation. L'ensemble du processus prend généralement 2 à 3 semaines, et nous avons des périodes d'admission régulières tout au long de l'année.",

    faq_question_4: "Événements d'appréciation des bénévoles",
    faq_answer_4:
      "Nous organisons régulièrement des événements d'appréciation pour reconnaître les contributions inestimables de nos bénévoles. Ceux-ci comprennent des galas annuels, des certificats de reconnaissance et un accès spécial aux événements culturels et sites de Marrakech.",

    faq_question_5: "Développement professionnel et personnel",
    faq_answer_5:
      "Le bénévolat avec Turâth offre de nombreuses opportunités de croissance personnelle et professionnelle. Vous développerez de nouvelles compétences, élargirez votre réseau et acquerrez une expérience précieuse dans la préservation du patrimoine, la gestion d'événements, la recherche, et plus encore.",

    faq_question_6: "Avoir un impact durable",
    faq_answer_6:
      "Nos bénévoles jouent un rôle crucial dans la préservation du riche patrimoine culturel de Marrakech pour les générations futures. Vos contributions aideront à documenter, restaurer et promouvoir les éléments architecturaux, artistiques et culturels uniques qui font la spécificité de cette ville.",

    faq_question_7: "Sensibiliser au bénévolat",
    faq_answer_7:
      "Aidez-nous à développer notre communauté de bénévoles en partageant votre expérience avec vos amis et votre famille. Vous pouvez également suivre et partager nos publications sur les réseaux sociaux, participer à nos événements publics et devenir un ambassadeur de la préservation du patrimoine dans votre communauté.",

    faq_question_8: "Comment devenir un partenaire externe",
    faq_answer_8:
      "Les organisations intéressées à s'associer avec Turâth peuvent contacter notre équipe de partenariat. Nous collaborons avec des établissements d'enseignement, des entreprises, des agences gouvernementales et d'autres ONG sur divers projets et initiatives.",

    faq_question_9: "Quels avantages Turâth offre-t-il aux bénévoles ?",
    faq_answer_9:
      "Nos bénévoles bénéficient d'une formation, d'opportunités de réseautage, d'invitations à des événements exclusifs, d'une reconnaissance pour leurs contributions, et de la satisfaction d'avoir un impact significatif sur la préservation du patrimoine culturel.",

    faq_question_10: "Formation et soutien des bénévoles",
    faq_answer_10:
      "Nous fournissons une formation complète et un soutien continu à tous nos bénévoles. Cela comprend des sessions d'orientation, des ateliers spécifiques aux compétences, un mentorat par des membres expérimentés de l'équipe, et des vérifications régulières pour s'assurer que vous disposez de tout ce dont vous avez besoin pour réussir.",

    faq_question_11: "Opportunités de bénévolat flexibles",
    faq_answer_11:
      "Nous comprenons que nos bénévoles ont divers engagements, nous offrons donc des options d'horaires flexibles. Vous pouvez faire du bénévolat régulièrement, pour des événements ou des projets spécifiques, ou à distance, selon votre disponibilité et vos intérêts.",

    faq_question_12: "Rôles de bénévolat diversifiés",
    faq_answer_12:
  ...
  ar: {
    ...
    // Image Alt Texts
    logo_alt: "شعار تراث",
    hero_image_alt: "عرض تراث مراكش",
    background_image_alt: "صورة الخلفية",
    ...
    contact_us: "اتصل بنا",
    contact_description: "هل لديك أسئلة حول عملنا أو ترغب في المشاركة؟ يسعدنا أن نسمع منك.",
    ...
    faq_answer_6:
      "يلعب متطوعونا دورًا حاسمًا في الحفاظ على التراث الثقافي الغني لمراكش للأجيال القادمة. ستساعد مساهماتك في توثيق وترميم وتعزيز العناصر المعمارية والفنية والثقافية الفريدة التي تجعل هذه المدينة مميزة.",

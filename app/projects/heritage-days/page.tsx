...
export default function HeritageProjectPage() {
  ...
  const project = {
    ...
    gallery: [
      ...
      "https://images.unsplash.com/photo-1594240500626-1e6d5c6de7dc?q=80&w=2070&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D",
    ],
    activities: [
          ...
          >
            ...
            <div className="md:col-span-2">
              ...
              <div className="prose max-w-none text-gray-700 font-tomato">
                ...
                <h3 className="text-xl font-bold text-gray-900 mt-8 mb-4">{t("activities")}</h3>
                ...
                <h3 className="text-xl font-bold text-gray-900 mt-8 mb-4">{t("goals")}</h3>
                <p>
